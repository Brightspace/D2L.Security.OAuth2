...
namespace D2L.Security.OAuth2.Keys {
    /// <summary>
    /// A token that has yet to be signed, supports complex claims
    /// </summary>
    public sealed class UnsignedComplexToken {
        ...
        /// <summary>
		/// Constructs a new <see cref="UnsignedComplexToken"/> instance
		/// </summary>
